...
* Execution: N/A 
* Program Description: 
* Creates an IronBrick class that implements the Brick interface.
...
public class IronBrick implements Brick {
    ...
    /** Constructor
     * Initiates the IronBrick entity with default values
     */
    public IronBrick(double xPosition, double yPosition) {
        //strongest with 3 strength
        this.strength = 3;
